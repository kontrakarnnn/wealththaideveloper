            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                  ...
                  <div class="row">
                    ...
                    <select  class="form-control condition" name="promotion_id" id="promotion_id" onchange="chgtext()">
                    <option value="" >-select-</option>
...
<input type="checkbox" id="checkoff5" value="1" onclick="chgtext()"/>@foreach($findoffertype as $fi){{$fi->offer_payment_name5}}@endforeach</label>

...
<div class="container">
    <div class="row">
        <div class="">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('case-type.update', ['id' => $data[$casetypecol[0]]]) }}">
                          ...
                          <div class="column">
                            ...
                            <select class="form-control  name" name="case_cat_id">
                              ...
                              @foreach ($casecat as $ca)
                                <option value="{{$ca->id}}"{{$ca->id == $data[$casetypecol[1]] ? 'selected' : ''}} >{{$ca->name}}</option>
                              @endforeach
                            </select>
                      ...
                      <div class="column">
                        ...
                        <select class="form-control  name" name="case_type_config">
                          ...
                          @foreach ($casetypeconfig as $ca)
                            <option value="{{$ca->id}}" {{1 == $data[$casetypecol[90]] ? 'selected' : ''}}>{{$ca->sub_type_config_name}}</option>
                          @endforeach
                        </select>
                        ...
                        <div class="column">
                          ...
                          <select class="form-control  name" name="default_partner_block_id">
                            ...
                            @foreach ($partnerblock as $ca)
                              <option value="{{$ca->id}}"{{$ca->id == $data[$casetypecol[3]] ? 'selected' : ''}} >{{$ca->name}}</option>
                            @endforeach
                          </select>
                        ...
                        <div class="column">
                          ...
                          <select class="form-control  name" name="default_user_block_id">
                            <option value="0" >-Select-</option>
                            @foreach ($block as $ca)
                              <option value="{{$ca->id}}" {{$ca->id == $data[$casetypecol[4]] ? 'selected' : ''}} >{{$ca->name}}</option>
                            @endforeach
                          </select>
                    ...
                    <div class="column">
                      ...
                      <select class="form-control  name" name="default_partner_group">
                        ...
                        @foreach ($partnergroup as $ca)
                          <option value="{{$ca->id}}"{{$ca->id == $data[$casetypecol[89]] ? 'selected' : ''}} >{{$ca->name}}</option>
                        @endforeach
                      </select>
                ...
                <div class="column">
                  ...
                  <select class="form-control  name" name="default_procedure_id">
                    ...
                    @foreach ($procedure as $ca)
                      <option value="{{$ca->id}}"{{$ca->id == $data[$casetypecol[5]] ? 'selected' : ''}} >{{$ca->name}}</option>
                    @endforeach
                  </select>
                ...
                <div class="column2">
                  <label for="name" class="">Type Name</label>
                      ...
                      <input id="name" type="text" class="form-control" name="name" value="{{$data[$casetypecol[2]]}}" required autofocus>
                  ...
                  <div class="column2">
                    <label for="day_auto_renew" class="">Day Auto Renew (วัน)</label>
                        <input id="day_auto_renew" type="text" class="form-control" name="day_auto_renew" value="{{$data->day_auto_renew}}" required autofocus>
                  ...
                  <div class="row">
                    <div class="column">
                      <label for="name" class="">Requirement Name1</label>
                          <input id="requirename_var1" type="text" class="form-control" name="requirename_var1"  value="{{ $data[$casetypecol[7]] }}" >
                ...
                <div class="column">
                  ...
                  <label for="requirename_var2" class="">Requirement Name2</label>
                      ...
                      <input id="requirename_var2" type="text" class="form-control" name="requirename_var2"  value="{{ $data[$casetypecol[8]] }}" >
            ...
            <div class="column">
              ...
              <label for="requirename_var3" class="">Requirement Name3</label>
                  ...
                  <input id="requirename_var3" type="text" class="form-control" name="requirename_var3"  value="{{ $data[$casetypecol[9]] }}" >
        ...
        <div class="column">
          ...
          <label for="requirename_var4" class="">Requirement Name4</label>
              ...
              <input id="requirename_var4" type="text" class="form-control" name="requirename_var4"  value="{{$data[$casetypecol[10]]}}" >
    ...
    <div class="column">
      ...
      <label for="requirename_var5" class="">Requirement Name5</label>
          ...
          <input id="requirename_var5" type="text" class="form-control" name="requirename_var5"  value="{{$data[$casetypecol[11]] }}" >
  ...
  <label for="requirename_var6" class="">Requirement Name6</label>
      ...
      <input id="requirename_var6" type="text" class="form-control" name="requirename_var6"  value="{{ $data[$casetypecol[12]] }}" >
      ...
      @endif
            ...
            <div class="row">
              <div class="column">
                ...
                <label for="requirename_var7" class="">Requirement Name7</label>
                    ...
                    <input id="requirename_var7" type="text" class="form-control" name="requirename_var7"  value="{{ $data[$casetypecol[13]] }}" >
          ...
          <div class="column">
            ...
            <label for="requirename_var8" class="">Requirement Name8</label>
                ...
                <input id="requirename_var8" type="text" class="form-control" name="requirename_var8"  value="{{ $data[$casetypecol[14]] }}" >
      ...
      <div class="column">
        ...
        <label for="requirename_var9" class="">Requirement Name9</label>
            ...
            <input id="requirename_var9" type="text" class="form-control" name="requirename_var9"  value="{{ $data[$casetypecol[15]]}}" >
  ...
  <div class="column">
    ...
    <label for="requirename_var10" class="">Requirement Name10</label>
        ...
        <input id="requirename_var10" type="text" class="form-control" name="requirename_var10"  value="{{ $data[$casetypecol[16]] }}" >
  ...
  <label for="requirename_var11" class="">Requirement Name11</label>
    ...
    <input id="requirename_var11" type="text" class="form-control" name="requirename_var11"  value="{{ $data[$casetypecol[17]] }}" >
  ...
  <input id="requirename_var12" type="text" class="form-control" name="requirename_var12"  value="{{ $data[$casetypecol[18]] }}" >
  ...
  @endif
      ...
      <div class="row">
        <div class="column">
          ...
          <label for="requirename_var13" class="">Requirement Name13</label>
              ...
              <input id="requirename_var13" type="text" class="form-control" name="requirename_var13"  value="{{ $data[$casetypecol[19]] }}" >
    ...
    <div class="column">
      ...
      <label for="requirename_var14" class="">Requirement Name14</label>
          ...
          <input id="requirename_var14" type="text" class="form-control" name="requirename_var14"  value="{{ $data[$casetypecol[20]] }}" >
  ...
  <label for="requirename_var15" class="">Requirement Name15</label>
      ...
      <input id="requirename_var15" type="text" class="form-control" name="requirename_var15"  value="{{ $data[$casetypecol[21]] }}" >
  ...
  <input id="requirename_var16" type="text" class="form-control" name="requirename_var16"  value="{{ $data[$casetypecol[22]] }}" >
  ...
  <input id="requirename_var17" type="text" class="form-control" name="requirename_var17"  value="{{ $data[$casetypecol[23]] }}" >
  ...
  <input id="requirename_var18" type="text" class="form-control" name="requirename_var18"  value="{{ $data[$casetypecol[24]] }}" >
  ...
  <input id="requirename_var19" type="text" class="form-control" name="requirename_var19"  value="{{ $data[$casetypecol[25]] }}" >
  ...
  <input id="requirename_var20" type="text" class="form-control" name="requirename_var20"  value="{{ $data[$casetypecol[26]] }}" >
  ...
  <div class="column">
    ...
    <label for="var_name1" class="">Variable Name1</label>
        ...
        <input id="var_name1" type="text" class="form-control" name="var_name1"  value="{{ $data[$casetypecol[27]] }}" >
  ...
  <label for="var_name2" class="">Variable Name2</label>
      ...
      <input id="var_name2" type="text" class="form-control" name="var_name2"  value="{{ $data[$casetypecol[28]] }}" >
  ...
  <label for="var_name3" class="">Variable Name3</label>
      ...
      <input id="var_name3" type="text" class="form-control" name="var_name3"  value="{{ $data[$casetypecol[29]] }}" >
  ...
  <label for="var_name4" class="">Variable Name4</label>
      ...
      <input id="var_name4" type="text" class="form-control" name="var_name4"  value="{{ $data[$casetypecol[30]] }}" >
  ...
  <label for="var_name5" class="">Variable Name5</label>
      ...
      <input id="var_name5" type="text" class="form-control" name="var_name5"  value="{{ $data[$casetypecol[31]] }}" >
  ...
  <label for="var_name6" class="">Variable Name6</label>
      ...
      <input id="var_name6" type="text" class="form-control" name="var_name6"  value="{{ $data[$casetypecol[32]] }}" >
  ...
  <div class="column">
    ...
    <label for="var_name7" class="">Variable Name7</label>
        ...
        <input id="var_name7" type="text" class="form-control" name="var_name7"  value="{{ $data[$casetypecol[33]] }}" >
  ...
  <label for="var_name8" class="">Variable Name8</label>
      ...
      <input id="var_name8" type="text" class="form-control" name="var_name8"  value="{{ $data[$casetypecol[34]] }}" >
  ...
  <label for="var_name9" class="">Variable Name9</label>
      ...
      <input id="var_name9" type="text" class="form-control" name="var_name9"  value="{{ $data[$casetypecol[35]] }}" >
  ...
  <label for="var_name10" class="">Variable Name10</label>
      ...
      <input id="var_name10" type="text" class="form-control" name="var_name10"  value="{{ $data[$casetypecol[36]] }}" >
  ...
  <label for="var_name11" class="">Variable Name11</label>
      ...
      <input id="var_name11" type="text" class="form-control" name="var_name11"  value="{{$data[$casetypecol[37]] }}" >
  ...
  <label for="var_name12" class="">Variable Name12</label>
      ...
      <input id="var_name12" type="text" class="form-control" name="var_name12"  value="{{ $data[$casetypecol[38]] }}" >
  ...
  <div class="column">
    ...
    <label for="var_name13" class="">Variable Name13</label>
        ...
        <input id="var_name13" type="text" class="form-control" name="var_name13"  value="{{ $data[$casetypecol[39]] }}" >
  ...
  <label for="var_name14" class="">Variable Name14</label>
      ...
      <input id="var_name14" type="text" class="form-control" name="var_name14"  value="{{ $data[$casetypecol[40]] }}" >
  ...
  <label for="var_name15" class="">Variable Name15</label>
      ...
      <input id="var_name15" type="text" class="form-control" name="var_name15"  value="{{ $data[$casetypecol[41]] }}" >
  ...
  <label for="var_name16" class="">Variable Name16</label>
      ...
      <input id="var_name16" type="text" class="form-control" name="var_name16"  value="{{ $data[$casetypecol[42]] }}" >
  ...
  <label for="var_name17" class="">Variable Name17</label>
      ...
      <input id="var_name17" type="text" class="form-control" name="var_name17"  value="{{ $data[$casetypecol[43]] }}" >
  ...
  <label for="var_name18" class="">Variable Name18</label>
      ...
      <input id="var_name18" type="text" class="form-control" name="var_name18"  value="{{ $data[$casetypecol[44]] }}" >
  ...
  <div class="column">
    ...
    <label for="var_name19" class="">Variable Name19</label>
        ...
        <input id="var_name19" type="text" class="form-control" name="var_name19"  value="{{ $data[$casetypecol[45]] }}" >
  ...
  <label for="var_name20" class="">Variable Name20</label>
      ...
      <input id="var_name20" type="text" class="form-control" name="var_name20"  value="{{ $data[$casetypecol[46]] }}" >
  ...
  <label for="var_name21" class="">Variable Name21</label>
      ...
      <input id="var_name21" type="text" class="form-control" name="var_name21"  value="{{ $data[$casetypecol[47]] }}" >
  ...
  <label for="var_name22" class="">Variable Name22</label>
      ...
      <input id="var_name22" type="text" class="form-control" name="var_name22"  value="{{ $data[$casetypecol[48]] }}" >
  ...
  <label for="var_name23" class="">Variable Name23</label>
      ...
      <input id="var_name23" type="text" class="form-control" name="var_name23"  value="{{$data[$casetypecol[49]] }}" >
  ...
  <label for="var_name24" class="">Variable Name24</label>
      ...
      <input id="var_name24" type="text" class="form-control" name="var_name24"  value="{{ $data[$casetypecol[50]] }}" >
  ...
  <div class="column">
    ...
    <label for="var_name25" class="">Variable Name25</label>
        ...
        <input id="var_name25" type="text" class="form-control" name="var_name25"  value="{{ $data[$casetypecol[51]] }}" >
  ...
  <label for="var_name26" class="">Variable Name26</label>
      ...
      <input id="var_name26" type="text" class="form-control" name="var_name26"  value="{{ $data[$casetypecol[52]] }}" >
  ...
  <label for="var_name27" class="">Variable Name27</label>
      ...
      <input id="var_name27" type="text" class="form-control" name="var_name27"  value="{{ $data[$casetypecol[53]] }}" >
  ...
  <label for="var_name28" class="">Variable Name28</label>
      ...
      <input id="var_name28" type="text" class="form-control" name="var_name28"  value="{{ $data[$casetypecol[54]] }}" >
  ...
  <label for="var_name29" class="">Variable Name29</label>
      ...
      <input id="var_name29" type="text" class="form-control" name="var_name29"  value="{{$data[$casetypecol[55]] }}" >
  ...
  <label for="var_name30" class="">Variable Name30</label>
      ...
      <input id="var_name30" type="text" class="form-control" name="var_name30"  value="{{ $data[$casetypecol[56]] }}" >
  ...
  <div class="column">
    ...
    <label for="var_name31" class="">Variable Name31</label>
        ...
        <input id="var_name31" type="text" class="form-control" name="var_name31"  value="{{ $data[$casetypecol[57]] }}" >
  ...
  <label for="var_name32" class="">Variable Name32</label>
      ...
      <input id="var_name32" type="text" class="form-control" name="var_name32"  value="{{ $data[$casetypecol[58]] }}" >
  ...
  <label for="var_name33" class="">Variable Name33</label>
      ...
      <input id="var_name33" type="text" class="form-control" name="var_name33"  value="{{ $data[$casetypecol[59]] }}" >
  ...
  <label for="var_name34" class="">Variable Name34</label>
      ...
      <input id="var_name34" type="text" class="form-control" name="var_name34"  value="{{ $data[$casetypecol[60]] }}" >
  ...
  <label for="var_name35" class="">Variable Name35</label>
      ...
      <input id="var_name35" type="text" class="form-control" name="var_name35"  value="{{ $data[$casetypecol[61]] }}" >
  ...
  <label for="var_name36" class="">Variable Name36</label>
      ...
      <input id="var_name36" type="text" class="form-control" name="var_name36"  value="{{ $data[$casetypecol[62]] }}" >
  ...
  <div class="column">
    ...
    <label for="var_name37" class="">Variable Name37</label>
        ...
        <input id="var_name37" type="text" class="form-control" name="var_name37"  value="{{ $data[$casetypecol[63]] }}" >
  ...
  <label for="var_name38" class="">Variable Name38</label>
      ...
      <input id="var_name32" type="text" class="form-control" name="var_name38"  value="{{ $data[$casetypecol[64]] }}" >
  ...
  <label for="var_name39" class="">Variable Name39</label>
      ...
      <input id="var_name39" type="text" class="form-control" name="var_name39"  value="{{ $data[$casetypecol[65]] }}" >
  ...
  <label for="var_name40" class="">Variable Name40</label>
      ...
      <input id="var_name40" type="text" class="form-control" name="var_name40"  value="{{ $data[$casetypecol[66]] }}" >
  ...
  <label for="var_name41" class="">Variable Name41</label>
      ...
      <input id="var_name41" type="text" class="form-control" name="var_name41"  value="{{ $data[$casetypecol[67]] }}" >
  ...
  <label for="var_name42" class="">Variable Name42</label>
      ...
      <input id="var_name42" type="text" class="form-control" name="var_name42"  value="{{ $data[$casetypecol[68]] }}" >
  ...
  <div class="column">
    ...
    <label for="var_name43" class="">Variable Name43</label>
        ...
        <input id="var_name43" type="text" class="form-control" name="var_name43"  value="{{ $data[$casetypecol[69]] }}" >
  ...
  <label for="var_name44" class="">Variable Name44</label>
      ...
      <input id="var_name44" type="text" class="form-control" name="var_name44"  value="{{ $data[$casetypecol[70]] }}" >
  ...
  <label for="var_name45" class="">Variable Name45</label>
      ...
      <input id="var_name45" type="text" class="form-control" name="var_name45"  value="{{ $data[$casetypecol[71]]}}" >
  ...
  <label for="var_name46" class="">Variable Name46</label>
      ...
      <input id="var_name46" type="text" class="form-control" name="var_name46"  value="{{ $data[$casetypecol[72]] }}" >
  ...
  <label for="var_name47" class="">Variable Name47</label>
      ...
      <input id="var_name47" type="text" class="form-control" name="var_name47"  value="{{ $data[$casetypecol[73]] }}" >
  ...
  <label for="var_name48" class="">Variable Name48</label>
      ...
      <input id="var_name48" type="text" class="form-control" name="var_name48"  value="{{ $data[$casetypecol[74]] }}" >
  ...
  <div class="column">
    ...
    <label for="var_name49" class="">Variable Name49</label>
        ...
        <input id="var_name49" type="text" class="form-control" name="var_name49"  value="{{ $data[$casetypecol[75]] }}" >
  ...
  <label for="var_name50" class="">Variable Name50</label>
      ...
      <input id="var_name50" type="text" class="form-control" name="var_name50"  value="{{$data[$casetypecol[76]] }}" >
  ...
  <label for="var_name51" class="">Variable Name51</label>
      ...
      <input id="var_name51" type="text" class="form-control" name="var_name51"  value="{{ $data[$casetypecol[77]] }}" >
  ...
  <label for="var_name52" class="">Variable Name52</label>
      ...
      <input id="var_name52" type="text" class="form-control" name="var_name52"  value="{{ $data[$casetypecol[78]] }}" >
  ...
  <label for="var_name53" class="">Variable Name53</label>
      ...
      <input id="var_name53" type="text" class="form-control" name="var_name53"  value="{{ $data[$casetypecol[79]] }}" >
  ...
  <label for="var_name54" class="">Variable Name54</label>
      ...
      <input id="var_name54" type="text" class="form-control" name="var_name54"  value="{{ $data[$casetypecol[80]] }}" >
  ...
  <div class="column">
    ...
    <label for="var_name55" class="">Variable Name55</label>
        ...
        <input id="var_name55" type="text" class="form-control" name="var_name55"  value="{{ $data[$casetypecol[81]] }}" >
  ...
  <label for="var_name56" class="">Variable Name56</label>
      ...
      <input id="var_name56" type="text" class="form-control" name="var_name56"  value="{{ $data[$casetypecol[82]] }}" >
  ...
  <label for="var_name57" class="">Variable Name57</label>
      ...
      <input id="var_name57" type="text" class="form-control" name="var_name57"  value="{{ $data[$casetypecol[83]]}}" >
  ...
  <label for="var_name58" class="">Variable Name58</label>
      ...
      <input id="var_name58" type="text" class="form-control" name="var_name58"  value="{{ $data[$casetypecol[84]] }}" >
  ...
  <label for="var_name59" class="">Variable Name59</label>
      ...
      <input id="var_name59" type="text" class="form-control" name="var_name59"  value="{{ $data[$casetypecol[85]] }}" >
  ...
  <label for="var_name60" class="">Variable Name60</label>
      ...
      <input id="var_name60" type="text" class="form-control" name="var_name60"  value="{{ $data[$casetypecol[86]] }}" >
  ...
  <div class="row">
    <div class="column">
      ...
      <label for="var_name61" class="">Variable Name61</label>
          ...
          <input id="var_name61" type="text" class="form-control" name="var_name61"  value="{{$data->var_name61}}" >
  ...
  <div class="column">
    ...
    <label for="var_name62" class="">Variable Name62</label>
        ...
        <input id="var_name62" type="text" class="form-control" name="var_name62"  value="{{ $data->var_name62 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name63" class="">Variable Name63</label>
        ...
        <input id="var_name63" type="text" class="form-control" name="var_name63"  value="{{ $data->var_name63 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name64" class="">Variable Name64</label>
        ...
        <input id="var_name64" type="text" class="form-control" name="var_name64"  value="{{ $data->var_name64 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name65" class="">Variable Name65</label>
        ...
        <input id="var_name65" type="text" class="form-control" name="var_name65"  value="{{ $data->var_name65 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name66" class="">Variable Name66</label>
        ...
        <input id="var_name66" type="text" class="form-control" name="var_name66"  value="{{ $data->var_name66 }}" >
  ...
  <div class="row">
    <div class="column">
      ...
      <label for="var_name67" class="">Variable Name67</label>
          ...
          <input id="var_name67" type="text" class="form-control" name="var_name67"  value="{{ $data->var_name67 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name68" class="">Variable Name68</label>
        ...
        <input id="var_name68" type="text" class="form-control" name="var_name68"  value="{{ $data->var_name68 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name69" class="">Variable Name69</label>
        ...
        <input id="var_name69" type="text" class="form-control" name="var_name69"  value="{{ $data->var_name69 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name70" class="">Variable Name70</label>
        ...
        <input id="var_name70" type="text" class="form-control" name="var_name70"  value="{{ $data->var_name70 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name71" class="">Variable Name71</label>
        ...
        <input id="var_name71" type="text" class="form-control" name="var_name71"  value="{{ $data->var_name71 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name72" class="">Variable Name72</label>
        ...
        <input id="var_name72" type="text" class="form-control" name="var_name72"  value="{{ $data->var_name72 }}" >
  ...
  <div class="row">
    <div class="column">
      ...
      <label for="var_name73" class="">Variable Name73</label>
          ...
          <input id="var_name73" type="text" class="form-control" name="var_name73"  value="{{ $data->var_name73 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name74" class="">Variable Name74</label>
        ...
        <input id="var_name74" type="text" class="form-control" name="var_name74"  value="{{ $data->var_name74 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name75" class="">Variable Name75</label>
        ...
        <input id="var_name75" type="text" class="form-control" name="var_name75"  value="{{ $data->var_name75 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name76" class="">Variable Name76</label>
        ...
        <input id="var_name76" type="text" class="form-control" name="var_name76"  value="{{ $data->var_name76 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name77" class="">Variable Name77</label>
        ...
        <input id="var_name77" type="text" class="form-control" name="var_name77"  value="{{ $data->var_name77 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name78" class="">Variable Name78</label>
        ...
        <input id="var_name78" type="text" class="form-control" name="var_name78"  value="{{ $data->var_name78 }}" >
  ...
  <div class="row">
    <div class="column">
      ...
      <label for="var_name79" class="">Variable Name79</label>
          ...
          <input id="var_name79" type="text" class="form-control" name="var_name79"  value="{{ $data->var_name79 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name80" class="">Variable Name80</label>
        ...
        <input id="var_name80" type="text" class="form-control" name="var_name56"  value="{{ $data->var_name80 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name81" class="">Variable Name81</label>
        ...
        <input id="var_name81" type="text" class="form-control" name="var_name81"  value="{{ $data->var_name81 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name82" class="">Variable Name82</label>
        ...
        <input id="var_name82" type="text" class="form-control" name="var_name82"  value="{{ $data->var_name82 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name83" class="">Variable Name83</label>
        ...
        <input id="var_name83" type="text" class="form-control" name="var_name83"  value="{{ $data->var_name83 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name84" class="">Variable Name84</label>
        ...
        <input id="var_name84" type="text" class="form-control" name="var_name84"  value="{{ $data->var_name84 }}" >
  ...
  <div class="row">
    <div class="column">
      ...
      <label for="var_name85" class="">Variable Name85</label>
          ...
          <input id="var_name85" type="text" class="form-control" name="var_name85"  value="{{ $data->var_name85 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name86" class="">Variable Name86</label>
        ...
        <input id="var_name86" type="text" class="form-control" name="var_name86"  value="{{ $data->var_name86 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name87" class="">Variable Name87</label>
        ...
        <input id="var_name87" type="text" class="form-control" name="var_name87"  value="{{ $data->var_name87 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name88" class="">Variable Name88</label>
        ...
        <input id="var_name88" type="text" class="form-control" name="var_name88"  value="{{ $data->var_name88 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name89" class="">Variable Name89</label>
        ...
        <input id="var_name89" type="text" class="form-control" name="var_name89"  value="{{ $data->var_name89 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name90" class="">Variable Name90</label>
        ...
        <input id="var_name90" type="text" class="form-control" name="var_name90"  value="{{ $data->var_name90 }}" >
  ...
  <div class="row">
    <div class="column">
      ...
      <label for="var_name91" class="">Variable Name91</label>
          ...
          <input id="var_name91" type="text" class="form-control" name="var_name91"  value="{{ $data->var_name91 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name92" class="">Variable Name92</label>
        ...
        <input id="var_name92" type="text" class="form-control" name="var_name92"  value="{{ $data->var_name92 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name93" class="">Variable Name93</label>
        ...
        <input id="var_name93" type="text" class="form-control" name="var_name93"  value="{{ $data->var_name93 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name94" class="">Variable Name94</label>
        ...
        <input id="var_name94" type="text" class="form-control" name="var_name94"  value="{{ $data->var_name94 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name95" class="">Variable Name95</label>
        ...
        <input id="var_name95" type="text" class="form-control" name="var_name95"  value="{{ $data->var_name95 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name96" class="">Variable Name96</label>
        ...
        <input id="var_name96" type="text" class="form-control" name="var_name96"  value="{{ $data->var_name96 }}" >
  ...
  <div class="row">
    <div class="column">
      ...
      <label for="var_name97" class="">Variable Name97</label>
          ...
          <input id="var_name97" type="text" class="form-control" name="var_name97"  value="{{ $data->var_name97 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name98" class="">Variable Name98</label>
        ...
        <input id="var_name98" type="text" class="form-control" name="var_name98"  value="{{ $data->var_name98 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name99" class="">Variable Name99</label>
        ...
        <input id="var_name99" type="text" class="form-control" name="var_name99"  value="{{ $data->var_name99 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name100" class="">Variable Name100</label>
        ...
        <input id="var_name100" type="text" class="form-control" name="var_name100"  value="{{ $data->var_name100 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name101" class="">Variable Name101</label>
        ...
        <input id="var_name101" type="text" class="form-control" name="var_name101"  value="{{ $data->var_name101 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name102" class="">Variable Name102</label>
        ...
        <input id="var_name102" type="text" class="form-control" name="var_name84"  value="{{ $data->var_name102 }}" >
  ...
  <div class="row">
    <div class="column">
      ...
      <label for="var_name103" class="">Variable Name103</label>
          ...
          <input id="var_name103" type="text" class="form-control" name="var_name103"  value="{{ $data->var_name103 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name104" class="">Variable Name104</label>
        ...
        <input id="var_name104" type="text" class="form-control" name="var_name104"  value="{{ $data->var_name104 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name105" class="">Variable Name105</label>
        ...
        <input id="var_name105" type="text" class="form-control" name="var_name105"  value="{{ $data->var_name105 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name106" class="">Variable Name106</label>
        ...
        <input id="var_name106" type="text" class="form-control" name="var_name106"  value="{{ $data->var_name106 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name107" class="">Variable Name107</label>
        ...
        <input id="var_name107" type="text" class="form-control" name="var_name107"  value="{{ $data->var_name107 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name108" class="">Variable Name108</label>
        ...
        <input id="var_name108" type="text" class="form-control" name="var_name108"  value="{{ $data->var_name108 }}" >
  ...
  <div class="row">
    <div class="column">
      ...
      <label for="var_name109" class="">Variable Name109</label>
          ...
          <input id="var_name109" type="text" class="form-control" name="var_name109"  value="{{ $data->var_name109 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name110" class="">Variable Name110</label>
        ...
        <input id="var_name110" type="text" class="form-control" name="var_name110"  value="{{ $data->var_name110 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name111" class="">Variable Name111</label>
        ...
        <input id="var_name111" type="text" class="form-control" name="var_name111"  value="{{ $data->var_name111 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name112" class="">Variable Name112</label>
        ...
        <input id="var_name112" type="text" class="form-control" name="var_name112"  value="{{ $data->var_name112 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name113" class="">Variable Name113</label>
        ...
        <input id="var_name113" type="text" class="form-control" name="var_name113"  value="{{ $data->var_name113 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name114" class="">Variable Name114</label>
        ...
        <input id="var_name114" type="text" class="form-control" name="var_name114"  value="{{ $data->var_name114 }}" >
  ...
  <div class="row">
    <div class="column">
      ...
      <label for="var_name115" class="">Variable Name115</label>
          ...
          <input id="var_name115" type="text" class="form-control" name="var_name115"  value="{{ $data->var_name115 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name116" class="">Variable Name116</label>
        ...
        <input id="var_name116" type="text" class="form-control" name="var_name116"  value="{{ $data->var_name116 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name117" class="">Variable Name117</label>
        ...
        <input id="var_name117" type="text" class="form-control" name="var_name117"  value="{{ $data->var_name117 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name118" class="">Variable Name118</label>
        ...
        <input id="var_name118" type="text" class="form-control" name="var_name118"  value="{{ $data->var_name118 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name119" class="">Variable Name119</label>
        ...
        <input id="var_name119" type="text" class="form-control" name="var_name119"  value="{{ $data->var_name119 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name120" class="">Variable Name120</label>
        ...
        <input id="var_name120" type="text" class="form-control" name="var_name120"  value="{{ $data->var_name120 }}" >
  ...
  <div class="row">
    <div class="column">
      ...
      <label for="var_name121" class="">Variable Name121</label>
          ...
          <input id="var_name121" type="text" class="form-control" name="var_name121"  value="{{ $data->var_name121 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name122" class="">Variable Name122</label>
        ...
        <input id="var_name122" type="text" class="form-control" name="var_name122"  value="{{ $data->var_name122 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name123" class="">Variable Name123</label>
        ...
        <input id="var_name123" type="text" class="form-control" name="var_name123"  value="{{ $data->var_name123 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name124" class="">Variable Name124</label>
        ...
        <input id="var_name124" type="text" class="form-control" name="var_name124"  value="{{ $data->var_name124 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name125" class="">Variable Name125</label>
        ...
        <input id="var_name125" type="text" class="form-control" name="var_name125"  value="{{ $data->var_name125 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name126" class="">Variable Name126</label>
        ...
        <input id="var_name126" type="text" class="form-control" name="var_name126"  value="{{ $data->var_name126 }}" >
  ...
  <div class="row">
    <div class="column">
      ...
      <label for="var_name127" class="">Variable Name127</label>
          ...
          <input id="var_name127" type="text" class="form-control" name="var_name103"  value="{{ $data->var_name127 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name128" class="">Variable Name128</label>
        ...
        <input id="var_name128" type="text" class="form-control" name="var_name128"  value="{{ $data->var_name128 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name129" class="">Variable Name129</label>
        ...
        <input id="var_name129" type="text" class="form-control" name="var_name129"  value="{{ $data->var_name129 }}" >
  ...
  <div class="column">
    ...
    <label for="var_name130" class="">Variable Name130</label>
        ...
        <input id="var_name130" type="text" class="form-control" name="var_name130"  value="{{ $data->var_name130 }}" >

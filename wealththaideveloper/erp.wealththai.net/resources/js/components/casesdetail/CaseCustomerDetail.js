    ...
    render() {
      return (
        ...
        <div className="box-header  ">
         ...
         <tr style={{border:'0.5px solid #E3E3E3',backgroundColor:'#F4F4F6'}}>
        <th style={{backgroundColor:'#F4F4F6',width:'50%',height:'70px',textAlign:'center'}}>E-mail	</th>
          <th style={{backgroundColor:'white'}}>&nbsp;{this.props.customeremail}</th>
        </tr>

         <tr style={{border:'0.5px solid #E3E3E3',backgroundColor:'#F4F4F6'}}>
        <th style={{backgroundColor:'#F4F4F6',width:'50%',height:'70px',textAlign:'center'}}>Fax</th>
          <th style={{backgroundColor:'white'}}>&nbsp;{this.props.customerfax}</th>
        </tr>
        <tr style={{border:'0.5px solid #E3E3E3',backgroundColor:'#F4F4F6'}}>

...
export default class TeamPerformance extends Component {
  ...
  {
    var bodyData = [];
    bodyData.push([ {text:'No.',fillColor:'silver'}, {text:'Structure Name',fillColor:'silver'}, {text:'Block Name',fillColor:'silver'}, {text:'Belong To',fillColor:'silver'}, {text:'User Name',fillColor:'silver'}, {text:'Block Commission',fillColor:'silver'}, {text:'% Income',fillColor:'silver'}]);
    ...
    let header = "Team Performance Report"
  ...
  tableshow()
  {
    ...
    else if (this.state.tableflag == 1)
    {
      return <div> <ReactHTMLTableToExcel
                    ...
                    table="table-to-xls"
                    filename="teab_perfomance_report"
                    sheet="tablexls"
...
if (document.getElementById('teamperformance')) {
    ReactDOM.render(<TeamPerformance />, document.getElementById('teamperformance'));
}

...
export default class InsuranceShowoffer extends Component {
...
onClickProposal(data){
  ...
  console.log("first",this.state.alloffer);
  ...
  console.log("last",this.state.alloffer);
}
  openclassicview()
  {
    ...
    if(this.state.classicviewflag == 1)
    {
      ...
      <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
        ...
        <tr role="row">
          ...
          <th   tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">ความเสียหายต่อรถยนต์(รถเรา)</th>
          <th   tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">ความเสียหายส่วนแรก(รถเรา)</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">รถยนต์สูญหาย/ไฟใหม้(รถเรา)  </th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">ความคุ้มครองน้ำท่วม</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">จำนวนคนที่คุ้มครอง</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">วงเงินความเสียหายต่อชีวิตร่างกายภายนอก(เฉพาะส่วนเกินพรบ)/คน</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">วงเงินความเสียหายต่อชีวิตร่างกายภายนอก(เฉพาะส่วนเกินพรบ)/ครั้ง</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">ความเสียหายต่อทรัพย์สิน(ภายนอก)</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">ความเสียหายส่วนแรก(ภายนอก)</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">วงเงินอุบัติเหตุบุคคลของคนขับ(แนบท้าย)</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">วงเงินอุบัติเหตุบุคคลของผู้โดยสาร(แนบท้าย)</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">วงเงินทุพลภาพชั่วคราว(คนขับ)</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">วงเงินทุพลภาพชั่วคราว(ผู้โดยสาร)</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">ค่ารักษาพยาบาล(ต่อคน)</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">วงเงินประกันตัวผู้ขับขี่</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">ความคุ้มครองน้ำท่วม</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">ความช่วยเหลือฉุกเฉิน Roadside Assistance</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">ติดเงื่อนไข เฉพาะรถติดกล้องหรือไม่</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">เป็นแบบระบุผู้ขับขี่หรือไม่ ถ้าใช่ โปรดระบุผู้ขับขี่ (ชื่อ/อายุ)</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">อื่นๆเพิ่มเติม</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">เบี้ยรวมหน้าตั๋ว</th>
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">ยอดหัก ณ ที่จ่าย * (ถ้ามีค่า)</th>
          ...
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">ค่าใช้จ่ายสุทธิที่ให้คำปรึกษา/แนะนำ ต้องจ่ายให้แก่บริษัท (Partner)</th>
          ...
          <th tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="port: activate to sort column ascending">ค่าใช้จ่ายสุทธิที่บริษัทต้องโอนไปบริษัทประกัน (Company)</th>
        ...
        <tr  role="row" class="odd">
          ...
          <th><a class="btn btn-warning btn-margin" href={'/wealththaiinsurance/offer/'+data.id+'/edit?prev/wealththaiinsurance/cases/'+this.state.caseid2+'/offer/show?blink/wealththaiinsurance/cases/'+this.state.caseid2+'/detail/show'}>แก้ไข</a></th>
              <th></th>
              ...
              <th >{this.totalpaidpartner(data)} บาท</th>
              <th >{this.totalpaiduser(data)} บาท</th>
              <th >{this.totalpaidcompany(data)} บาท</th>
            </tr>
          )}
            </tbody>
      ...
      <table id="example2" class="table table-bordered table-hover dataTable" role="grid" aria-describedby="example2_info">
        ...
        <tr  role="row" class="odd">
          <th style={{textAlign:'center'}}>{this.showcheckbox(data)}</th>
              ...
              <th><a class="btn btn-warning btn-margin" href={'/wealththaiinsurance/offer/'+data.id+'/edit?prev/wealththaiinsurance/cases/'+this.state.caseid2+'/offer/show?blink/wealththaiinsurance/cases/'+this.state.caseid2+'/detail/show'}>แก้ไข</a>
              ...
              <div class="modal" id={"myModal"+data.id} role="dialog">
                ...
                <div class="tab-content" style={{padding:'10px'}}>
                  <div id={"home"+data.id} class="tab-pane  in active">
                    ...
                    <label for="username" class="col-md-4 control-label">เบี้ยรวมหน้าตั๋ว</label>
                    <div class="col-md-7">
                    ...
                    <div class="column2fordis">
                    <label for="username" class="col-md-4 control-label">ส่วนลดพิเศษจาก Partner</label>
                    <div class="col-md-7">
                    {this.discountfrompartnerlevel(data)}
                    </div>
                    <label for="username" class="col-md-4 control-label">&nbsp;</label>
                    <div class="col-md-6">
                    &nbsp;
                    ...
                    <tr  role="row" class="odd">
                    <td>ส่วนลดพิเศษจาก Partner </td>
                    <td style={{textAlign:'right',color:'red'}}>{this.state.discountpartnerlv}</td>
                    <td style={{textAlign:'right'}}>{this.state.netpremiumpartnerlv} บาท</td>
                    </tr>
                    <tr  role="row" class="odd">
...
if (document.getElementById('insuranceshowoffer')) {
    ReactDOM.render(<InsuranceShowoffer />, document.getElementById('insuranceshowoffer'));
}

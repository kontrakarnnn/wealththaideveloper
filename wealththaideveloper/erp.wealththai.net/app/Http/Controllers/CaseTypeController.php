...
class CaseTypeController extends Controller
{
    ...
    public function index()
    {
      ...
      $data = CaseType::with(['Partner_group','CaseCategory','Partner_block','Block'])->paginate(30);
      return view('system-mgmt/case-type/index', ['procedure' => $procedure,'casetypeconfig' => $casetypeconfig,'partnergroup' => $partnergroup,'casetype' => $casetype,'block' => $block,'partnerblock' => $partnerblock,'casecatcol' => $casecatcol,'casetypecol' => $casetypecol,'casecat' => $casecat,'data' => $data]);
    }
    ...
    public function create()
    {
      ...
      $partnerblock = Partner_block::all();
        ...
        $casetypeconfig = CaseTypeConfig::all();
        $procedure = Procedures::all();
        return view( 'system-mgmt/case-type/create',compact('procedure','casetypeconfig','partnergroup','block','partnerblock','casecat'));
    }
    ...
    public function edit($id)
    {
      ...
      $casecat = CaseCategory::all();
        ...
        return view( 'system-mgmt/case-type/edit', ['procedure' => $procedure,'casetypeconfig' => $casetypeconfig,'partnergroup' => $partnergroup,'casecatcol' => $casecatcol,'casetypecol' => $casetypecol,'block' => $block,'partnerblock' => $partnerblock,'casecat' => $casecat,'data' => $data]);
    }
    ...
    public function search(Request $request) {
       ...
       $partnergroup = Partner_group::all();
      $casetype =  CaseType::with(['CaseCategory','Partner_block','Block'])->get();
       return view( 'system-mgmt/case-type/index', ['procedure' => $procedure,'casetypeconfig' => $casetypeconfig,'partnergroup' => $partnergroup,'casetype' => $casetype,'block' => $block,'partnerblock' => $partnerblock,'casecatcol' => $casecatcol,'casetypecol' => $casetypecol,'casecat' => $casecat,'data' => $data, 'searchingVals' => $constraints]);
    }

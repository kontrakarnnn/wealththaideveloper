...
class InvoiceController extends Controller
{
     ...
     public function invoice($id)
      {
        ...
        else
        {
          ...
          else
          {
            ...
            if($offeract->branch->add_subdistrict == NULL ||$offerinsurance->branch->add_subdistrict == '' || $offerinsurance->branch->add_subdistrict == 0)
            {
              $addsubdistrict = '';
            }
            else
            ...
            if($offeract->branch->add_district == NULL ||$offerinsurance->branch->add_district == '' || $offerinsurance->branch->add_district == 0)
            {
              $adddistrict = '';
            }
            else
 ...
 <table style='width:1000px;margin-top:-20px' class='table'>
   ...
   <tr>
     ...
     <td class='table' style='background-color:#dedee3'>ผู้ขับขี่</td>
     <td class='table'>{$offervalue3}</td>
     <td class='table' style='background-color:#dedee3'>ต่อคน</td>
   ...
   <tr>
     ...
     <td class='table' style='background-color:#dedee3'>ทุนประกัน</td>
     <td class='table'>{$offervalue5}</td>
     <td class='table' style='background-color:#dedee3'>ไฟไหม้/หาย</td>
     <td class='table'>{$offervalue7}</td>
     <td class='table' style='background-color:#dedee3'>น้ำท่วม</td>
   ...
   <tr>
     ...
     <td class='table' style='background-color:#dedee3'>วงเงินอุบัติเหตุ</td>
     <td class='table'>{$offervalue8}</td>
     <td class='table' style='background-color:#dedee3'>จำนวนผู้โดยสาร</td>
     <td class='table'>{$offervalue19}</td>
     <td class='table' style='background-color:#dedee3'>วงเงินอุบัติเหตุ(ผู้โดยสาร)</td>
     <td class='table'>{$offervalue9}</td>
    </tr>
   <tr>
     <td colspan='5'style='background-color:#dedee3'>รายละเอียดเพิ่มเติม</td>
     <td class='table' style='background-color:#dedee3'>วงเงินทุพพลภาพชั่วคราว(คนขับ)</td>
     <td colspan='2'class='table'>{$offervalue10}</td>
     <td class='table' style='background-color:#dedee3'>วงเงินทุวงเงินทุพพลภาพชั่วคราว(ผู้โดยสาร)</td>
     <td colspan='2'class='table'>{$offervalue11}</td>

   <tr>
     <td colspan='5'class='table'>ฐ$moredetail</td>
     <td class='table' style='background-color:#dedee3'>ค่ารักษาพยาบาล</td>
     <td colspan='2'class='table'>{$offervalue12}</td>
     <td class='table' style='background-color:#dedee3'>ค่าประกันตัว</td>
